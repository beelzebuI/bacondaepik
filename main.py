...
twitch_miner = TwitchChannelPointsMiner(
    username="bacondaepik",
    password="baongk11c",           # If no password will be provided, the script will ask interactively
